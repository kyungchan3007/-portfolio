...
### [웹 접근성 개선](/projects/accessibility)
**FMS · BEMS · 원격 제어 시스템 공통 적용 · ㈜TSM Technology · FE 개발**

세 개 서비스에 같은 기준으로 적용한 웹 접근성 정비 작업입니다.
heading·landmark·ARIA 관계·포커스·색 대비를 전면 정리하고, axe + Playwright 자동 점검으로 회귀를 막는 체계를 만들었습니다.

`Semantic HTML` `WAI-ARIA` `focus-visible` `Playwright` `@axe-core/playwright`

---

### [성능 최적화](/projects/performance)
**FMS · BEMS · 원격 제어 시스템 공통 적용 · ㈜TSM Technology · FE 개발**
